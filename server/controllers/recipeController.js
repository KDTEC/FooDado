...
//         const latest = { latestRecipes, thai, american, chinese }

//         res.render('index', { title: 'Cooking Blog- Homepage', categories, latest })
//     } catch (error) {
...
// // for exploring the recipe categories page
...
// // for getting the recipe category by id
...
//   //for gwtting the recipe of a particular dish
...
// // for exploring the latest recipes
...
// function for inserting dummy data
...
//                 "description": `Before you start, remove the butter from the fridge and allow to come up to room temperature.
...
//   Source: https://www.jamieoliver.com/recipes/chocolate-recipes/gluten-free-chocolate-cake/`,
//                 "email": "hello@email.com",
//                 "ingredients": [
